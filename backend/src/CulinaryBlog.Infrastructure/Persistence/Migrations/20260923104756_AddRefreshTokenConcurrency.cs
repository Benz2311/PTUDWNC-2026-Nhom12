...
[Migration("20260923104756_AddRefreshTokenConcurrency")]
public class AddRefreshTokenConcurrency : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		object obj = new byte[0];
		migrationBuilder.AddColumn<byte[]>("RowVersion", "RefreshTokens", "bytea", (bool?)null, (int?)null, false, (string)null, false, obj, (string)null, (string)null, (bool?)null, (string)null, (string)null, (int?)null, (int?)null, (bool?)null);
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropColumn("RowVersion", "RefreshTokens", (string)null);
	}
