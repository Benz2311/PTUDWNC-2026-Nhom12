...
[Migration("20260923103026_RemoveUnusedImageVariants")]
public class RemoveUnusedImageVariants : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropColumn("MediumUrl", "RecipeImages", (string)null);
		migrationBuilder.DropColumn("ThumbnailUrl", "RecipeImages", (string)null);
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		int? num = 500;
		migrationBuilder.AddColumn<string>("MediumUrl", "RecipeImages", "character varying(500)", (bool?)null, num, false, (string)null, true, (object)null, (string)null, (string)null, (bool?)null, (string)null, (string)null, (int?)null, (int?)null, (bool?)null);
		num = 500;
		migrationBuilder.AddColumn<string>("ThumbnailUrl", "RecipeImages", "character varying(500)", (bool?)null, num, false, (string)null, true, (object)null, (string)null, (string)null, (bool?)null, (string)null, (string)null, (int?)null, (int?)null, (bool?)null);
	}
